...
This chapter covers the basics of the CoAP protocol. It also shows how to use CoAP in the **actuator**, **sensor** and **controller** projects, each running on separate Raspberry Pis or Raspberry Pi 2s.
